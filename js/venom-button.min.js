var sendMessageBtn = $("#send-message-btn").text();
! function($) {
    ...
    $.fn.venomButton = function(options) {
        ...
        if ($buttonImageContainer.addClass("venom-button-button-image"), $button.addClass("venom-button-button").append($(settings.buttonImage)).css({
            ...
            function openPopup() {
                $popup.hasClass("active") || ($popup.addClass("active"), $button.focus())
            }
            $button.text(sendMessageBtn), $button.addClass("btn btn-primary whatsapp-send-button"), $popup.addClass("venom-button-popup"), $header.addClass("venom-button-head"), $popupMessage.addClass("venom-button-message"), $inputMessage.addClass("venom-button-input-message"), $btnSend.addClass("venom-button-btn-send"), $popupMessage.text(settings.popupMessage), $button.val(settings.message), settings.popupMessage || $popupMessage.hide(), $header.append("<span>" + settings.headerTitle + "</span>", $closeBtn).css("background-color", settings.headerColor), $btnSend.append($sendIcon), $inputMessage.append($button, $btnSend), $closeBtn.addClass("close").html("&times;"), $popup.append($header, $popupMessage, $inputMessage).appendTo(this), $popupMessage.click((function() {})), $closeBtn.click((function() {})), $header.click((function() {
                $popup.removeClass("active")
            })), $button.click((function(event) {
                $btnSend.click();
            })), $btnSend.click((function() {
                settings.message = $button.val(), sendWhatsappMessage()
